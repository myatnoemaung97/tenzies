...
function App() {
  ...
  return (
    <>
      <section className='--tenzies d-flex flex-column gap-3 text-white'>
        ...
        <button onClick={roll} className='--roll-btn btn btn-warning mx-auto px-4 mt-3'>{tenzies ? 'New Game' : 'Roll'}</button>
      </section>
      {tenzies && <Confetti />}
    </>
  )
